package com.netdisk.entity.config;
...
public class AppConfig {
    ...
    @Value("${project.ffmpeg.path:}")
    private String projectFfmpegPath;

    public String getProjectFfmpegPath() {
     ...
     * 用户默认网盘空间
     */
    @Value("${user.space.default:}")
    private Integer userDefaultSpace;

    public Integer getUserDefaultSpace() {
        return userDefaultSpace;
    }
